...
Xtrain_path = "hf://datasets/aanjana/PIMA-Diabetes-Prediction-V1/Xtrain.csv"                    # enter the Hugging Face username here
Xtest_path = "hf://datasets/aanjana/PIMA-Diabetes-Prediction-V1/Xtest.csv"                      # enter the Hugging Face username here
ytrain_path = "hf://datasets/aanjana/PIMA-Diabetes-Prediction-V1/ytrain.csv"                    # enter the Hugging Face username here
ytest_path = "hf://datasets/aanjana/PIMA-Diabetes-Prediction-V1/ytest.csv"                      # enter the Hugging Face username here
