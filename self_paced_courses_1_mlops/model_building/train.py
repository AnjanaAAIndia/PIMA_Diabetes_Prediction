...
Xtrain_path = "hf://datasets/anjanaa/PIMA-Diabetes-Prediction/Xtrain.csv"                    # enter the Hugging Face username here
Xtest_path = "hf://datasets/anjanaa/PIMA-Diabetes-Prediction/Xtest.csv"                      # enter the Hugging Face username here
ytrain_path = "hf://datasets/anjanaa/PIMA-Diabetes-Prediction/ytrain.csv"                    # enter the Hugging Face username here
ytest_path = "hf://datasets/anjanaa/PIMA-Diabetes-Prediction/ytest.csv"                      # enter the Hugging Face username here
