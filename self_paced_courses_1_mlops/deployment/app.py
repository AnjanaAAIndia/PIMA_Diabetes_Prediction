...
model_path = hf_hub_download(repo_id="aanjana/PIMA-Diabetes-Prediction-V1", filename="best_pima_diabetes_model_v1.joblib")                                       # enter the Hugging Face username here
